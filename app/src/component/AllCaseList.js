...
class AllCaseList extends Component {
    ...
    render() {
        ...
        const caseList = currentCases.map(aCase => {
            ...
            if (aCase.isCaseResolved === "No" || currentUser.roles.includes("ROLE_HR_SUPERVISOR") || currentUser.roles.includes("ROLE_ADMIN")) {
                editButtonDisabled = false;
            }
            // if (aCase.isCaseResolved === "No") {editButtonDisabled = false}
            // if (aCase.isCaseResolved === "Yes" && currentUser.roles.includes("ROLE_HR_SUPERVISOR")) {editButtonDisabled = false}
            // if (aCase.isCaseResolved === "Yes" && currentUser.roles.includes("ROLE_ADMIN")) {editButtonDisabled = false}
