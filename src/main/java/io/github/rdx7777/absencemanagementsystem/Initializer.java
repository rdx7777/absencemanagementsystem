...
//            .withIsCoverRequired(ActionStatus.No)
//            .withIsCoverProvided(ActionStatus.No)
//            .withIsApprovedByHeadTeacher(ActionStatus.No)
//            .withIsAbsencePaid(ActionStatus.No)
...
//            .withIsApprovedByHeadTeacher(ActionStatus.Yes)
//            .withIsAbsencePaid(ActionStatus.Yes)
//            .withIsCaseResolved(ActionStatus.No)
//            .build();
